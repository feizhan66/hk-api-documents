...
返回碼|提示信息|原因|解決方案
----|----|----|----
200|成功|正常|按照具體業務邏輯處理
201|刷卡結果未知狀態|系統繁忙、用戶支付中等原因|等待15s通過【查詢訂單API】查詢
404|找不到該接口|接口地址錯誤|根據文檔檢查接口地址
4001|數據格式錯誤|數據格式不符|請使用JSON數據格式
4002|無效APPID|APPID不存在|檢查APPID是否錯誤
4003|缺少參數|缺少參數|按照提示補全參數
4004|簽名錯誤|簽名驗證錯誤|檢查代碼簽名邏輯
4005|通訊出錯|微信服務器錯誤|按提示排查代碼錯誤之後，向藍海技術人員反饋協助您解決問題
4006|服務器繁忙|服務器繁忙|稍後再重新調用該接口
4007|請求方式錯誤|請求方式錯誤|請使用POST方式
40100|無效請求||根據提示處理
40101|訂單已支付||按照具體業務邏輯處理
40102|訂單不存在||按照具體業務邏輯處理
40103|訂單已關閉||按照具體業務邏輯處理
40104|訂單已撤銷||按照具體業務邏輯處理
40105|訂單已退款||按照具體業務邏輯處理
40106|訂單號重復||商戶重新生成訂單號
40107|餘額不足||檢查商戶賬戶餘額是否不足
40108|訂單超過退款期限||無法完成退款
40109|缺少參數||按照提示補全參數
40110|編碼格式錯誤||請使用UTF8編碼格式
40111|每個二維碼只可以用一次||重新獲取用戶支付二維碼
40400|系統繁忙|系統繁忙|系統繁忙，稍後重試
40500|微信錯誤||向藍海技術人員反饋協助您解決問題
40600|未知錯誤|(未收錄錯誤)|向藍海技術人員反饋協助您解決問題
